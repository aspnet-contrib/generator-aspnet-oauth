...
namespace Microsoft.AspNetCore.Builder {
    ...
    public static class <%= name %>AuthenticationExtensions {
        /// <summary>
        /// Adds the <see cref="<%= name %>AuthenticationMiddleware"/> middleware to the specified <see cref="IApplicationBuilder"/>, which enables <%= name %> authentication capabilities.
        /// </summary>
